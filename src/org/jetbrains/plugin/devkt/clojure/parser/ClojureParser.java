...
import org.jetbrains.plugin.devkt.clojure.ClojureBundle;
import org.jetbrains.plugin.devkt.clojure.lexer.ClojureTokenTypes;
import org.jetbrains.plugin.devkt.clojure.parser.util.ParserUtils;

import java.util.Arrays;
import java.util.Set;

import static org.jetbrains.plugin.devkt.clojure.parser.ClojureElementTypes.*;
import static org.jetbrains.plugin.devkt.clojure.parser.ClojureSpecialFormTokens.DEF_TOKENS;
...
public class ClojureParser implements PsiParser, ClojureTokenTypes {
	...
	public static final Set<String> NS_TOKENS = new HashSet<>();
