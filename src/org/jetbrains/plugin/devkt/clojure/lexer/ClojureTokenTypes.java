...
import org.jetbrains.plugin.devkt.clojure.parser.ClojureElementType;
...
public interface ClojureTokenTypes {
	...
	TokenSet LITERALS = TokenSet.create(STRING_LITERAL, WRONG_STRING_LITERAL, LONG_LITERAL, BIG_INT_LITERAL, DOUBLE_LITERAL, BIG_DECIMAL_LITERAL, RATIO, CHAR_LITERAL, TRUE, FALSE, NIL);
